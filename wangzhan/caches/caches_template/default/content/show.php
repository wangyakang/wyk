	...
	<div class="gushi_neirong">
		...
		<div class="right">
			...
			<div class="neirong_xinwen">
				<p class="title_xuedi"><?php echo $title;?></p>
				<p class="yuedu_xuedi">浏览次数：<?php echo $CATEGORYS[$catid]['hits'];?>    日期：<?php echo $inputtime;?></p>
				<ul>
					<li>
						<a href="<?php echo $v['url'];?>"><?php echo $v['title'];?> <br /></a>
						<?php echo $content;?>
					</li>
				</ul>
			</div>
