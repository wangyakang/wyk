...
class index {
	function __construct() {		
		...
		define('WAP_SITEURL', $this->wap['domain'] ? $this->wap['domain'].'libs.php?' : APP_PATH.'libs.php?m=wap&siteid='.$this->siteid);
	...
	public function init() {
		...
		$template = $WAP_SETTING['index_template'] ? $WAP_SETTING['index_template'] : 'libs';
	...
	public function lists() {
		...
		//构造wap url规则
		define('URLRULE', 'libs.php?m=wap&c=libs&a=lists&typeid={$typeid}~libs.php?m=wap&c=libs&a=lists&typeid={$typeid}&page={$page}');
