...
class album extends admin {
	...
	public function __construct() {
		...
		if (!module_exists('video')) {
			showmessage(L('please_setting_video_info'), 'libs.php?m=admin&c=module&a=init');
		}
		if (!$this->setting) showmessage(L('please_not_setting_info'), 'libs.php?m=video&c=video&a=setting');
	...
	public function import() {
		...
		if ($id) {
			...
			if ($result) showmessage(L('album_add_success'), 'libs.php?m=special&c=special');
