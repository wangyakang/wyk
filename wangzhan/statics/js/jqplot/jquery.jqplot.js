...
(function($) {
    ...
    function Series() {
        ...
        // prop: libs
        // 0 based libs of this series in the plot series array.
        this.index;
        // prop: fill
    ...
    function jqPlot() {
        ...
        // It can be an empty object {}.  idx is the series libs
        ...
        //
        // Parameters:
        // idx - 0 based libs of the series to move.  This will be the libs of the series
        ...
        // This method requires jQuery 1.4+
        // Restore the series canvas order to its previous status.
   ...
   $.jqplot.ColorGenerator = function(colors) {
        ...
        // get a color by libs without advancing pointer.
        this.get = function(i) {
            ...
            if (this.autoscale && this.min == null && this.max == null) {
                ...
                for (var i=0; i<this._series.length; i++) {
                    ...
                    if (this.name == faname) {
                        ...
                        // if not a bar and not filling, only change existing status
	 ...
	 * call the jsDate.regional.getLocale() method.  Currently, en, fr and template are defined.</p>
	 * 
