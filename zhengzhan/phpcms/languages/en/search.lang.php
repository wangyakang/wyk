...
$LANG['re_index_note'] = '1.Rebuilding the search libs will be wiped clean all cached searching.';
$LANG['tiao'] = 'items';
...
$LANG['searh_notice'] = 'Warning: full text libs module requires that mysql enables full text libs function. How to enable? Edit mysql configuration file -> Set window server to my.ini -> Set linux server to my.cnf -> Add a line "ft_min_word_len=1" after [mysqld] -> restart mysql
';
?>