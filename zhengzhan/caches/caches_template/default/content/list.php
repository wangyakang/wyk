...
<div class="inpage_main">
		<ul class="about_left">
			...
			<ul class="captionmenu">
				<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=ccf7035c99864685e1232cf34635f21f&action=category&catid=%24top_parentid&order=id+ASC&num=10\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'category')) {$data = $content_tag->category(array('catid'=>$top_parentid,'order'=>'id ASC','limit'=>'10',));}?>
