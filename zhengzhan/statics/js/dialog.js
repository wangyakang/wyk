...
artDialog.fn = artDialog.prototype = {
	...
	lock: function () {
		...
		lockMaskWrap[0].style.cssText = sizeCss + ';position:fixed;z-libs:'
		...
		if (_isIE6) lockMask.html(
			...
			'top:0;left:0;z-libs:-1;filter:alpha(opacity=0)"></iframe>');
	...
	_ie6SelectFix: _isIE6 ? function () {
		...
		if (iframe) {
			...
			iframe.style.cssText = 'position:absolute;z-libs:-1;left:0;top:0;'
