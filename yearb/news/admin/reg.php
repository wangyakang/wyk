...
<body>
	<div class="img">
		<img src="../bj/bg1.jpg" alt="" />
	</div>
	<div class="sign">
        <div class="section">
            <form id="form" action="addReg.php" method="post">
                <div class="form-item">
                    <h2>注册页</h2>
                </div>
                <div class="form-item"><i class="icon-user-md icon"></i>
                	<span class="message"></span>
                    <input v-model="user.name" v-on:click="input_focus()" type="text" class="form-input" name="username" autocomplete="off" placeholder="用户姓名">
                    <div class="bot-bar"></div> 
                </div>
                <div class="form-item"><i class="icon-mobile-phone icon"></i>
                	<span class="message"></span>
                    <input v-model="user.phone" v-on:click="input_focus()" type="text" class="form-input" name="password" autocomplete="off" placeholder="用户密码">
                    <div class="bot-bar"></div>
                </div>
                <div class="form-item special">
                    <input type="submit" value="注册" class="form-submit" data-txt="Login" disabled="disabled" name="btn"/>
                </div>
                <span>
                	已完成注册，去
