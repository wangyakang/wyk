...
app.get("/update",function (req,res) {
    ...
    // console.log(aa)
    connection.query(`update xinxi set ${ziduan} = '${val}' where id=`+id,function (error,rows) {
            res.send("ok");
    })
})
//添加
app.get("/add",function(req,res){
    ...
    connection.query(`insert into xinxi (name,sex,age) values ('${name}','${sex}','${age}')`,function(error,result){
        res.send("ok");
    })
})
